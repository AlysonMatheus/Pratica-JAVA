...
class MangaTest {
    ...
    @Test
    public void equals_ReturnTrue_WhenObjectsAteTheSame() {
        Assertions.assertEquals(manga1, manga2);

    }
    @Test
    public void hashCode_ReturnTrue_WhenObjectsAteTheSame() {
    ...
    @Test
    public void isRecord_ReturnTrue_WhenNCalledFromManga() {
