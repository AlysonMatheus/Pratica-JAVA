...
//        searchPricesAsyncFuture(storeService);
    ...
    private static void searchPrinceSync(StoreService storeService) {
        ...
        System.out.println(storeService.getPriceSynsc("Store 1"));
        System.out.println(storeService.getPriceSynsc("Store 2"));
        System.out.println(storeService.getPriceSynsc("Store 3"));
        System.out.println(storeService.getPriceSynsc("Store 4"));
