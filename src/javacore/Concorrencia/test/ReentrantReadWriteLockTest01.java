...
class MapReadWWrite {
    ...
    public MapReadWWrite(ReentrantReadWriteLock rwl) {
        this.rwl = rwl;
    }
...
public class ReentrantReadWriteLockTest01 {
    public static void main(String[] args) {
        ...
        MapReadWWrite mapReadWrite = new MapReadWWrite(rwl);
        ...
        Runnable reader = () -> {
          ...
          try {
              System.out.println(Thread.currentThread()+ "" + mapReadWrite.allKeys());
